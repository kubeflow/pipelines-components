...
# 3. FILTER (default: empty - no filtering)

# Examples:
.github/scripts/detect-changed-assets/detect.sh origin/develop HEAD
.github/scripts/detect-changed-assets/detect.sh origin/main HEAD '\.py$'
.github/scripts/detect-changed-assets/detect.sh origin/main HEAD '\.(py|yaml)$'
```
