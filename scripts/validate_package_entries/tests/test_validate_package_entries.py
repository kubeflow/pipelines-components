...
class TestDiscoverPackages:
    ...
    def test_discover_components_packages(self, tmp_path: Path):
    ...
    def test_discover_nested_packages(self, tmp_path: Path):
...
class TestValidatePackageEntries:
    ...
    def test_valid_sync(self, tmp_path: Path):
...
"""
    ...
    def test_missing_packages(self, tmp_path: Path):
...
"""
    ...
    def test_both_missing_and_extra(self, tmp_path: Path):
