...
def process_asset(
    ...
    if not functions:
        functions = find_any_decorated_functions(module)
    ...
    result["invalid_base_images"] = validate_base_images(result["base_images"], config.allowed_prefix, config.allowlist)
