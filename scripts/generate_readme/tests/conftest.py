...
def sample_component_file():
    ...
    fixture_path = Path(__file__).parent / "fixtures" / "sample_component.py"
...
def sample_pipeline_file():
    ...
    fixture_path = Path(__file__).parent / "fixtures" / "sample_pipeline.py"
    return fixture_path.read_text()
...
def component_multiline_overview():
    ...
    fixture_path = Path(__file__).parent / "fixtures" / "component_multiline_overview.py"
    return fixture_path.read_text()
...
def component_no_docstring():
    ...
    fixture_path = Path(__file__).parent / "fixtures" / "component_no_docstring.py"
    return fixture_path.read_text()
...
def sample_component_metadata():
    ...
    fixture_path = Path(__file__).parent / "fixtures" / "sample_component_metadata.yaml"
    return fixture_path.read_text()
...
def sample_pipeline_metadata():
    ...
    fixture_path = Path(__file__).parent / "fixtures" / "sample_pipeline_metadata.yaml"
    return fixture_path.read_text()
