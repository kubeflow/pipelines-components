...
def component_dir(temp_dir, sample_component_file, sample_component_metadata):
    ...
    return create_component_dir(temp_dir, "test_component", sample_component_file, sample_component_metadata)


@pytest.fixture
def pipeline_dir(temp_dir, sample_pipeline_file, sample_pipeline_metadata):
    """Create a complete pipeline directory structure."""
    return create_pipeline_dir(temp_dir, "test_pipeline", sample_pipeline_file, sample_pipeline_metadata)
