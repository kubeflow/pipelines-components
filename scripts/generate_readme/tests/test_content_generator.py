...
class TestReadmeContentGenerator:
    ...
    def test_init_with_component(self, component_dir, sample_extracted_metadata):
        ...
        generator = ReadmeContentGenerator(sample_extracted_metadata, component_dir)
    ...
    def test_init_with_pipeline(self, pipeline_dir, sample_extracted_metadata):
        ...
        generator = ReadmeContentGenerator(sample_extracted_metadata, pipeline_dir)
...
""")
        ...
        generator = ReadmeContentGenerator(sample_extracted_metadata, temp_dir)
...
""")
    ...
    def test_prepare_template_context_custom_overview(self, component_dir):
        ...
        generator = ReadmeContentGenerator(custom_metadata, component_dir)
    ...
    def test_generate_readme_component(self, component_dir, sample_extracted_metadata):
        ...
        # Regenerate readme
        generator2 = ReadmeContentGenerator(sample_extracted_metadata, component_dir)
    ...
    def test_generate_readme_empty_metadata(self, temp_dir):
        ...
        minimal_metadata = {"name": "test", "overview": "", "parameters": {}, "returns": {}}

        generator = ReadmeContentGenerator(minimal_metadata, temp_dir)
