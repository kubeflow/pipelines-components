...
def _write_pipeline_asset(tmp_path: Path, source_file: Path) -> Path:
...
class TestFindDecoratedFunctions:
    ...
    def test_detects_component_and_pipeline_decorators(self, tmp_path: Path):
        ...
        decorated = find_decorated_function_names_ast(
            _TEST_DATA_DIR / "fixture_test_find_decorated_function_names_ast__attribute_form.py"
        )
    ...
    def test_detects_call_form_decorators(self, tmp_path: Path):
        ...
        decorated = find_decorated_function_names_ast(
            _TEST_DATA_DIR / "fixture_test_find_decorated_function_names_ast__call_form.py"
        )
    ...
    def test_detects_async_functions(self, tmp_path: Path):
        ...
        decorated = find_decorated_function_names_ast(
            _TEST_DATA_DIR / "fixture_test_find_decorated_function_names_ast__async_functions.py"
        )
...
class TestValidateCompilation:
    ...
    def test_validates_components_and_pipelines(self, tmp_path: Path, monkeypatch):
        ...
        component_file.write_text(
            (_TEST_DATA_DIR / "fixture_test_validate_compilation__component_module.py").read_text()
        )

        _write_pipeline_asset(
            tmp_path,
            _TEST_DATA_DIR / "fixture_test_validate_compilation__pipeline_module.py",
        )
